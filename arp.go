...
// Handler providers an interface which allows structs to act as ARP server
...
// ARP handlers. If f is a function with the approriate signature,
// HandleFunc(f) is a Handler struct that calls f
...
// ResponseSender provides an interface which allows an ARP handler to construct
